---
title: "Quickstart"
description: "Send stablecoins seamlessly"
---
...
<AccordionGroup>
    <Accordion icon="copy" title="Clone your docs locally">
        ...
        repository in your [dashboard](https://dashboard.mintlify.com). To clone
        the repository locally so that you can make and preview changes to your
        docs, follow the [Cloning a
    ...
    <Accordion icon="rectangle-terminal" title="Start the preview server">
        ...
        directory and run: `mint dev` 3. Open `http://localhost:3000` to see
        your docs live!
...
<Note>
    **Need help?** See our [full documentation](https://mintlify.com/docs) or
